...
public class S2CSyncStatsSender {
    ...
    public static void send(ServerPlayer serverPlayer) {
        ...
        float hydrationLevel = ((ManagerAccess) serverPlayer).lobeCorp$getWaterManager().getHydrationLevel();
        ...
        float desiccationLevel = ((ManagerAccess) serverPlayer).lobeCorp$getWaterManager().getDesiccationLevel();
