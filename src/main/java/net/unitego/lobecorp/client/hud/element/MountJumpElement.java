...
public class MountJumpElement extends BaseElement {
    ...
    public void draw(GuiGraphics guiGraphics, float partialTick, int guiWidth, int guiHeight) {
        ...
        drawRect(guiGraphics, x + gap, y + gap, width - gap * 2, height - gap * 2, HUDResource.BG2);
        //渲染坐骑跳跃条
        drawRect(guiGraphics, x + gap, y + gap, width * jumpRidingScale - gap * 2, height - gap * 2, HUDResource.MOUNT_JUMP_BAR);
    }
}
