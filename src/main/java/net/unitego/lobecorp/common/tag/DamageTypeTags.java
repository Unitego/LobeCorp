package net.unitego.lobecorp.common.tag;
 ...
 */
public enum DamageTypeTags implements Supplier<TagKey<DamageType>> {
    /**
     * 红、白、黑、蓝四色伤害都有碎盾机制，并且都无视原版护甲
     * 受到红、白、黑、蓝四色伤害大于伤害吸收值或认知同化值的时候，会直接归于0
     * 然后玩家依旧会吃满这次伤害，不会被抵消掉一部分
     */
    CENSORED_DAMAGE_TYPE,//掉虚空、边界外、指令杀
    DEPLETED_DAMAGE_TYPE,//饥饿、干渴
