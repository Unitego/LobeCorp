...
public class ModCreativeModeTabs {
    ...
    public static final DeferredHolder<CreativeModeTab, CreativeModeTab> LOBE_CORP = CREATIVE_MODE_TAB.register("lobe_corp", () -> CreativeModeTab.builder()
            .title(Component.translatable(LOBE_CORP_NAME))
            .icon(() -> ModItems.LOBE_CORP_LOGO.get().getDefaultInstance())
