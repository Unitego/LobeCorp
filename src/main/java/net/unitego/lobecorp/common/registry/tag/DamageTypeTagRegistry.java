...
public enum DamageTypeTagRegistry implements Supplier<TagKey<DamageType>> {
     ...
     */
    RED,//红伤只扣除玩家生命值，然后会受到四色抗性与等级压制的影响
    WHITE,//白伤只扣除玩家精神值，玩家精神值归零会进入恐慌状态
    BLACK,//黑伤生命和精神都扣
    PALE,//蓝伤对于玩家走百分比伤害扣除生命，
    SPIRIT,//有insane和mystic，insane你可以看作原版的wither，mystic相当于原版的magic
    CENSORED;//掉虚空、边界外、指令杀、饥饿、干渴
